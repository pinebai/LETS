...
print(' gamma1 (frozen) %.3f '% (gamma1_fr) )
...
print(' gamma1 (frozen) %.4f '% (gamma2_fr) )   
print(' gamma2 (equilibrium) %.4f '% (gamma2_eq) )   

#compute the effective value of q based on two-gamma model
M1 = cj_speed/a1_fr;
eparam = a1_fr**2*(M1**(-2)*(gamma2_eq/gamma1_fr)**2*(1+gamma1_fr*M1**2)**2/(2*(gamma2_eq**2-1))-1/(gamma1_fr-1)-M1**2/2)
