...
print('Explosion Parameters')

P1 = ct.one_atm; T1 = 300
mech = 'H2ChemMevel.cti'
...
for i in range(npoints):
    ...
    # ZND Structure
    ZNDout = zndsolve(gas1,gas,Ucj[-1])
    ...
    Ta = Ts*(1.02)
    gas.TPX = Ta,Ps,x
    CVout1 = cvsolve(gas,t_end=5e-5,dt=1e-8)
    Tb = Ts*(0.98)
    gas.TPX = Tb,Ps,x
    CVout2 = cvsolve(gas,t_end=5e-5,dt=1e-8)   
