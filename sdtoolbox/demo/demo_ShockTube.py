...
#CASE = 'gas'  # nonreactive gas driver
#CASE = 'uv'   # constant pressure gas driver
CASE = 'cj';   # detonation driver (initiation at diaphragm)

print('demo_ShockTube, case: '+CASE)

## set initial state, composition, and gas object for driven section
P1 = 100000.; T1 = 300. 
q1 = 'N2:1.0 O2:3.76';   
driven_mech = 'airNASA9.cti'
...
Ustart = a1*1.01; Ustop = 5*a1; Ustep = 25
...
if CASE=='gas':
    ...
    EQ_EXP = False
    P_driver = 15*P1; T_driver = 300.;
    q4 = 'He:1.0'   
    driver_mech = 'h2air_highT.cti'
